<template>
    <div class="w-48 h-100 fixed-top bg--light z--index">
        <p class="text--dark fs-4 font-bold mb-5 text-center mt-3">madJam</p>
            <ul class="px-3">
                <li class="mb-3">
                    <nuxt-link to="/home" class="p-2 rounded-md">
...
export default {
  components: { subscribe, Contribute },
    name: 'desktopSidenav'
}
</script>
<style scoped>
